...
public class StudentControl {
    ...
    @GetMapping("Stud/add")
    public List<Student>frontstuddetail(){
        return service.giveliststud();
    }
    @PostMapping("ggt/student")
    public String postfrontstudent(@RequestParam int id,
                                   @RequestParam String name,
                                   @RequestParam String department,
                                   @RequestParam String gender){
        return service.postfrontstud(id,name,department,gender);
    }
